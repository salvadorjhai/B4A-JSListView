...
public class customtemplate4 extends android.support.v7.app.AppCompatActivity implements B4AActivity{
	public static customtemplate4 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example.jslistview", "b4a.example.jslistview.customtemplate4");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (customtemplate4).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example.jslistview", "b4a.example.jslistview.customtemplate4");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.jslistview.customtemplate4", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (customtemplate4) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (customtemplate4) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (customtemplate4) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
mostCurrent._activity.LoadLayout("1",mostCurrent.activityBA);
 //BA.debugLineNum = 27;BA.debugLine="Activity.Title = \"Custom Listview 2\"";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence("Custom Listview 2"));
 //BA.debugLineNum = 29;BA.debugLine="Dim js As JSONParser";
_js = new anywheresoftware.b4a.objects.collections.JSONParser();
 //BA.debugLineNum = 30;BA.debugLine="js.Initialize(File.ReadString(File.DirAssets, \"MO";
_js.Initialize(anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"MOCK_DATA.json"));
 //BA.debugLineNum = 31;BA.debugLine="Dim data As List = js.NextArray";
...
mostCurrent._jslistview1.setOverscrollFooter((android.graphics.drawable.Drawable)(_cd.getObject()));
 //BA.debugLineNum = 47;BA.debugLine="JSListView1.DataSource = data";
mostCurrent._jslistview1.setDataSource(mostCurrent._v5);
...
mostCurrent._jslistview1.setFastScrollEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 50;BA.debugLine="Activity.Title = \"Custom Listview 2 - Total: \" &";
...
uk.co.martinpearman.b4a.squareup.picasso.Picasso _picaso = null;
 //BA.debugLineNum = 61;BA.debugLine="Sub JSListView1_OnGetView(position As Int, itemLay";
 //BA.debugLineNum = 62;BA.debugLine="Log($\"JSListView1_OnGetView @ Position: ${positio";
anywheresoftware.b4a.keywords.Common.Log(("JSListView1_OnGetView @ Position: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_position))+""));
 //BA.debugLineNum = 64;BA.debugLine="Dim iv As ItemViewLayout = itemLayout";
_iv = _itemlayout;
 //BA.debugLineNum = 66;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 67;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 68;BA.debugLine="If forViewUpdate = False Then";
if (_forviewupdate==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 69;BA.debugLine="p.LoadLayout(\"CustomLayout2\")";
_p.LoadLayout("CustomLayout2",mostCurrent.activityBA);
 //BA.debugLineNum = 70;BA.debugLine="iv.Container = p";
...
mostCurrent._label3.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("JosefinSans-SemiBoldItalic.ttf"));
 //BA.debugLineNum = 90;BA.debugLine="Label3.Gravity = Gravity.TOP";
mostCurrent._label3.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.TOP);
 //BA.debugLineNum = 92;BA.debugLine="iv.Height = ImageView1.Top + ImageView1.Height +";
_iv.setHeight((int) (mostCurrent._imageview1.getTop()+mostCurrent._imageview1.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))));
 //BA.debugLineNum = 93;BA.debugLine="iv.Width = 100%x";
...
mostCurrent._label2.setObject((android.widget.TextView)(_iv.findViewWithTag((Object)(2))));
 //BA.debugLineNum = 100;BA.debugLine="Label3 = iv.findViewWithTag(3)";
mostCurrent._label3.setObject((android.widget.TextView)(_iv.findViewWithTag((Object)(3))));
 //BA.debugLineNum = 101;BA.debugLine="ImageView1 = iv.findViewWithTag(4)";
...
_p.setObject((android.view.ViewGroup)(_iv.getContainer()));
 //BA.debugLineNum = 108;BA.debugLine="If position Mod 2 = 0 Then";
if (_position%2==0) { 
 //BA.debugLineNum = 109;BA.debugLine="p.Color = Colors.Transparent";
_p.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 }else {
 //BA.debugLineNum = 111;BA.debugLine="p.Color = Colors.ARGB(20, 100, 100, 100)";
...
_picaso.Initialize(processBA);
 //BA.debugLineNum = 116;BA.debugLine="picaso.LoadUrl(mapper.Get(\"avatar\")).Resize(Image";
