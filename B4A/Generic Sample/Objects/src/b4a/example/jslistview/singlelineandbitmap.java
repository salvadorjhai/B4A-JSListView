...
public class singlelineandbitmap extends android.support.v7.app.AppCompatActivity implements B4AActivity{
	public static singlelineandbitmap mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example.jslistview", "b4a.example.jslistview.singlelineandbitmap");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (singlelineandbitmap).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example.jslistview", "b4a.example.jslistview.singlelineandbitmap");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.jslistview.singlelineandbitmap", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (singlelineandbitmap) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (singlelineandbitmap) Resume **");
...
@Override
 ...
 protected void onStop() {
    ...
    public static Class<?> getObject() {
		return singlelineandbitmap.class;
	}
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (singlelineandbitmap) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
mostCurrent._activity.LoadLayout("1",mostCurrent.activityBA);
 //BA.debugLineNum = 26;BA.debugLine="Activity.Title = \"Single Line Item and bitmap\"";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence("Single Line Item and bitmap"));
...
mostCurrent._vvv3.setObject((java.util.List)(_m.Get((Object)("recipes"))));
 //BA.debugLineNum = 33;BA.debugLine="JSListView1.DataSource = recipes";
mostCurrent._jslistview1.setDataSource(mostCurrent._vvv3);
 //BA.debugLineNum = 34;BA.debugLine="JSListView1.FastScrollEnabled = True";
...
uk.co.martinpearman.b4a.squareup.picasso.Picasso _picaso = null;
 //BA.debugLineNum = 46;BA.debugLine="Sub JSListView1_OnGetView(position As Int, itemLay";
 //BA.debugLineNum = 47;BA.debugLine="Dim iv As ItemViewLayout = itemLayout";
_iv = _itemlayout;
 //BA.debugLineNum = 49;BA.debugLine="If forViewUpdate = False Then";
if (_forviewupdate==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 50;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 51;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 52;BA.debugLine="p.LoadLayout(\"SingleLineBitmap\")";
_p.LoadLayout("SingleLineBitmap",mostCurrent.activityBA);
 //BA.debugLineNum = 53;BA.debugLine="iv.Container = p";
_iv.setContainer((android.view.ViewGroup)(_p.getObject()));
 //BA.debugLineNum = 55;BA.debugLine="Label1.Tag = 1";
mostCurrent._label1.setTag((Object)(1));
 //BA.debugLineNum = 56;BA.debugLine="Label1.Width = 100%x - Label1.Left - 10dip";
mostCurrent._label1.setWidth((int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._label1.getLeft()-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))));
 //BA.debugLineNum = 58;BA.debugLine="Label1.Typeface = Typeface.LoadFromAssets(\"Josef";
mostCurrent._label1.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("JosefinSans-Bold.ttf"));
 //BA.debugLineNum = 60;BA.debugLine="ImageView1.Tag = 2";
mostCurrent._imageview1.setTag((Object)(2));
 //BA.debugLineNum = 62;BA.debugLine="iv.Height = ImageView1.Top + ImageView1.Height +";
_iv.setHeight((int) (mostCurrent._imageview1.getTop()+mostCurrent._imageview1.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))));
 //BA.debugLineNum = 63;BA.debugLine="iv.Width = 100%x";
_iv.setWidth(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA));
 };
 //BA.debugLineNum = 66;BA.debugLine="Dim mapper As Map = recipes.Get(position)";
...
_mapper.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(mostCurrent._vvv3.Get(_position)));
 //BA.debugLineNum = 68;BA.debugLine="Label1 = iv.findViewWithTag(1)";
mostCurrent._label1.setObject((android.widget.TextView)(_iv.findViewWithTag((Object)(1))));
 //BA.debugLineNum = 69;BA.debugLine="ImageView1 = iv.findViewWithTag(2)";
mostCurrent._imageview1.setObject((android.widget.ImageView)(_iv.findViewWithTag((Object)(2))));
 //BA.debugLineNum = 71;BA.debugLine="Label1.Text = mapper.Get(\"title\")";
mostCurrent._label1.setText(BA.ObjectToCharSequence(_mapper.Get((Object)("title"))));
 //BA.debugLineNum = 72;BA.debugLine="Dim picaso As Picasso";
_picaso = new uk.co.martinpearman.b4a.squareup.picasso.Picasso();
 //BA.debugLineNum = 73;BA.debugLine="picaso.Initialize";
_picaso.Initialize(processBA);
 //BA.debugLineNum = 74;BA.debugLine="picaso.LoadUrl(mapper.Get(\"image\")).Resize(ImageV";
...
public static String  _jslistview1_onitemclick(com.salvadorjhai.widgets.JSListView.ItemViewLayout _view,int _position) throws Exception{
 //BA.debugLineNum = 78;BA.debugLine="Sub JSListView1_OnItemClick(view As ItemViewLayout";
 //BA.debugLineNum = 79;BA.debugLine="Log(GetType(view))";
anywheresoftware.b4a.keywords.Common.Log(anywheresoftware.b4a.keywords.Common.GetType((Object)(_view)));
 //BA.debugLineNum = 80;BA.debugLine="ToastMessageShow($\"JSListView1_OnItemClick @ posi";
...
public static String  _jslistview1_onitemlongclick(com.salvadorjhai.widgets.JSListView.ItemViewLayout _view,int _position) throws Exception{
 //BA.debugLineNum = 83;BA.debugLine="Sub JSListView1_OnItemLongClick(view As ItemViewLa";
 //BA.debugLineNum = 84;BA.debugLine="Log(GetType(view))";
anywheresoftware.b4a.keywords.Common.Log(anywheresoftware.b4a.keywords.Common.GetType((Object)(_view)));
 //BA.debugLineNum = 85;BA.debugLine="ToastMessageShow($\"JSListView1_OnItemLongClick @";
