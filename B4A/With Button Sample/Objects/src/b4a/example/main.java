...
RDebugUtils.currentLine=917516;
 //BA.debugLineNum = 917516;BA.debugLine="lblDrugname.Text = mapData.Get(\"drug_name\")";
mostCurrent._lbldrugname.setText(BA.ObjectToCharSequence(_mapdata.Get((Object)("drug_name"))));
RDebugUtils.currentLine=917517;
 //BA.debugLineNum = 917517;BA.debugLine="lblQuantity.Text = mapData.Get(\"quantity\")";
mostCurrent._lblquantity.setText(BA.ObjectToCharSequence(_mapdata.Get((Object)("quantity"))));
RDebugUtils.currentLine=917519;
 //BA.debugLineNum = 917519;BA.debugLine="Dim picaso As Picasso";
_picaso = new uk.co.martinpearman.b4a.squareup.picasso.Picasso();
RDebugUtils.currentLine=917520;
 //BA.debugLineNum = 917520;BA.debugLine="picaso.Initialize";
_picaso.Initialize(processBA);
RDebugUtils.currentLine=917521;
 //BA.debugLineNum = 917521;BA.debugLine="picaso.LoadUrl(mapData.Get(\"image\")).Resize(imgAv";
_picaso.LoadUrl(BA.ObjectToString(_mapdata.Get((Object)("image")))).Resize(mostCurrent._imgavatar.getWidth(),mostCurrent._imgavatar.getHeight()).CenterCrop().IntoImageView((android.widget.ImageView)(mostCurrent._imgavatar.getObject()));
RDebugUtils.currentLine=917523;
 //BA.debugLineNum = 917523;BA.debugLine="btnAdd.Tag = position";
mostCurrent._btnadd.setTag((Object)(_position));
RDebugUtils.currentLine=917524;
 //BA.debugLineNum = 917524;BA.debugLine="btnMinus.Tag = position";
mostCurrent._btnminus.setTag((Object)(_position));
RDebugUtils.currentLine=917525;
 //BA.debugLineNum = 917525;BA.debugLine="lblDrugname.Tag = position";
...
RDebugUtils.currentLine=720903;
 //BA.debugLineNum = 720903;BA.debugLine="viewHolder.Initialize(p, 140dip, 100%x)";
_viewholder.Initialize((android.view.ViewGroup)(_p.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (140)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA));
RDebugUtils.currentLine=720906;
 //BA.debugLineNum = 720906;BA.debugLine="lblDrugname.Width = 100%x - lblDrugname.Left - 1";
...
RDebugUtils.currentLine=720907;
 //BA.debugLineNum = 720907;BA.debugLine="lblDrugname.Gravity = Bit.Or(Gravity.LEFT, Gravi";
